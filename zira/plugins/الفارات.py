...
ZelzalVP_cmd = (
    ...
    "⪼ `.اضف فار كروب الرسائل` بالـرد ع ايدي الجروب \n\n"
    "⪼ `.اضف فار كروب السجل` بالـرد ع ايدي الجروب \n\n"
    ...
    "\n𓆩 [ 𝐀𝐋𝐏𝐎𝐏 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/U5_X4) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if gvarstatus("TG_2STEP_VERIFICATION_CODE") is None:
            addgvar(variable, vinfo)
            await zed.edit("**⎉╎تم إضافـة {} بنجـاح ☑️**\n**⎉╎كـود التحـقق بخطـوتيـن** \n {} \n\n**⎉╎الان قـم بـ ارسـال الامـر ↶** `.تحويل ملكية` **ثم معـرف الشخـص داخـل الجروب  او القنـاة . .**".format(input_str, vinfo))
        else:
            addgvar(variable, vinfo)
            await zed.edit("**⎉╎تم إضافـة {} بنجـاح ☑️**\n**⎉╎كـود التحـقق بخطـوتيـن** \n {} \n\n**⎉╎الان قـم بـ ارسـال الامـر ↶** `.تحويل ملكية` **ثم معـرف الشخـص داخـل الجروب  او القنـاة . .**".format(input_str, vinfo))
