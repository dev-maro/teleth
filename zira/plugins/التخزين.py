...
async def log(log_text):
    ...
    if BOTLOG:
        if log_text.reply_to_msg_id:
            ...
            return
        await log_text.edit("**⌔┊تـم الحفـظ في جروب  التخـزين .. بنجـاح ✓**")
    else:
...
@zedub.zed_cmd(
    pattern="تخزين الجروبات  (تفعيل|تعطيل)$",
...
async def set_grplog(event):
    ...
    if GRPLOG:
        if h_type:
            await event.edit("**- تخزين الجروب ات بالفعـل ممكـن ✓**")
        else:
            addgvar("GRPLOG", h_type)
            await event.edit("**- تـم تعطيـل تخـزين تاكـات الجروب ات .. بنجـاح✓**")
    elif h_type:
        addgvar("GRPLOG", h_type)
        await event.edit("**- تـم تفعيـل تخـزين تاكـات الجروب ات .. بنجـاح✓**")
    else:
        await event.edit("**- تخزين الجروب ات بالفعـل معطـل ✓**")
