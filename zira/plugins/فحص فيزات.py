...
""" 
CC Checker & Generator for ZThon™ t.me/SOURCE_ALPOP
Write file by Zelzal T.me/VIP_ALPOP
hhh o ya beby
...
async def song2(event):
    ...
    chat = "@SDBB_Bot" # code by T.me/VIP_ALPOP
...
async def song2(event): # code by T.me/VIP_ALPOP
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by T.me/VIP_ALPOP
    chat = "@SDBB_Bot" # code by <T.me/VIP_ALPOP
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by T.me/VIP_ALPOP
    chat = "@SDBB_Bot" # code by T.me/VIP_ALPOP
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by T.me/VIP_ALPOP
    chat = "@SDBB_Bot" # code by T.me/VIP_ALPOP
    reply_id_ = await reply_id(event)
