...
Abuse Notifications for ZThon™ t.me/SOURCE_ALPOP
    ...
    if len(zed) == 2:
        ...
        for _ in range(counter):
            ...
            if event.reply_to_msg_id:
                ...
                await event.client.send_message('@AbuseNotifications', spam_message) # code by T.me/VIP_ALPOP
        ...
        return
    if DelaySpam is not True: # code by T.me/VIP_ALPOP
        if BOTLOG:
